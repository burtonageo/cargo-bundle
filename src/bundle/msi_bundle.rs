...
fn create_control_table(package: &mut Package, _cabinets: &[CabinetInfo]) -> crate::Result<()> {
    ...
    let actions: [ControlTableEntry; 38] = [
        ...
        (
            ...
            196611,
            "",
            "{\\TitleFont}Welcome to the [ProductName] setup wizard",
            "",
            "",
        ),
        (
        ...
        (
            ...
            3,
            "",
            "Do you want to abort [ProductName] [Text_action]?",
            "",
            "",
        ),
        (
        ...
        (
            ...
            196611,
            "",
            "{\\BoldFont}[Text_Doing] [ProductName]",
            "",
            "",
        ),
        ...
        (
            ...
            196611,
            "",
            "{\\TitleFont}[ProductName] [Text_action] complete",
            "",
            "",
        ),
        (
        ...
        (
            ...
            196611,
            "",
            "{\\TitleFont}[ProductName] [Text_agent] ended prematurely",
            "",
            "",
        ),
        (
